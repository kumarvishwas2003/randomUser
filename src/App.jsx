    ...
    <div className="frame-container h-screen w-screen flex">
      <div className="left-div w-1/2 flex flex-col justify-center items-center ">
        <div className="main-container bg-[rgb(248,249,254)] h-4/5 w-5/6 flex flex-col justify-center items-center drop-shadow-xl">
          <div className="mini-container bg-white w-4/6 h-4/6 p-4 relative">
            ...
            <div className="email-div flex justify-start mt-3"><button className=' bg-[rgb(14,204,239)] px-2 text-white'>✉️Email</button></div>
            ...
            <div className="name-div">
              <div className="name-1">hdsafuihdu</div>
              <div className="name-2">hjasdfuihdui</div>
            </div>
            <hr />
